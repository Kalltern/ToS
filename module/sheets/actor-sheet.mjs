 ...
 * @extends {ActorSheet}
 */
export class TosActorSheet extends ActorSheet {
  /** @override */
  ...
  /** @override */
  get template() {
    return `systems/tos/templates/actor/actor-${this.actor.data.type}-sheet.html`;
  }
  ...
  _prepareCharacterData(context) {
    ...
    for (let [k, v] of Object.entries(context.data.skillsdata.skills)) {
      v.label = game.i18n.localize(CONFIG.TOS.skills[k]) ?? k;
    }
  }
